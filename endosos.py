...
def create_pdf(content):
    ...
    pdf.output(pdf_buffer)  # Guardar PDF en el buffer
    pdf_buffer.seek(0)  # Mover al inicio del buffer
    return pdf_buffer
...
if uploaded_file:
    ...
    st.text_area("Extracted Content", value=cleaned_text, height=400)
